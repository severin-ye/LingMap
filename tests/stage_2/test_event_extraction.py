...
class TestEventExtractor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if os.path.exists(real_test_file):
            ...
            if real_chapter and real_chapter.segments:
                # TODO: Translate - Use真实数据的前两个段落作为Test数据
                self.test_chapter = Chapter(
                    ...
                    segments=real_chapter.segments[:2]  # TODO: Translate - Use前两个段落
                )
            else:
                # TODO: Translate - 如果LoadFailed，Use备用数据
                self.test_chapter = Chapter(
                    chapter_id="第一章",
                    title="山边小村",
        ...
        # TODO: Translate - 基于真实数据的模拟eventExtract结果
    ...
    def test_extract_events(self, mock_load_json, mock_extract):
        ...
        # TODO: Translate - 模拟call_with_json_response的Return值
        mock_extract.return_value = {
            "success": True,
            "json_content": self.mock_event_result[0]
        }
        
        # TODO: Translate - CreateExtract器实例
        ...
        self.assertGreater(len(events), 0)  # TODO: Translate - Verify有event被Extract出来
        self.assertIsInstance(events[0], EventItem)
        
        # TODO: Translate - CheckExtract的event属性是否符合预期
        event_descriptions = [e.description for e in events]
        self.assertTrue(len(event_descriptions) > 0)  # TODO: Translate - 确保有event被Extract
        
        # TODO: Translate - Verifyevent内容合理性（基于真实数据）
        for event in events:
            ...
            # TODO: Translate - Verifyevent包含真实的角色信息
    ...
    def test_extraction_error_handling(self, mock_load_json, mock_llm_client):
        ...
        # TODO: Translate - Set模拟的LLM调用抛出异常
        ...
        # TODO: Translate - ExecuteeventExtract，应该Return空列表而非抛出异常
        events = extractor.extract(self.test_chapter)
    ...
    def test_extract_events_from_real_data(self, mock_load_json, mock_extract):
        ...
        # TODO: Translate - Verifyevent内容的真实性
        ...
        self.assertGreater(len(first_event.description), 5)  # TODO: Translate - 描述应该有一定长度
        
        # TODO: Translate - Verifychapter关联正确
